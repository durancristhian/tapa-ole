...
import logoImage from './assets/images/logo-ole.png';
import poweradeImage from './assets/images/logo-powerade.png';
    ...
    xhttp.onreadystatechange = function() {
      ...
      if (this.readyState === 4) {
        ...
        if (this.status >= 200 && this.status < 300) {
          ...
          twitterEl.href = `https://twitter.com/intent/tweet?text=${titleEl.value}&url=${result}`;
